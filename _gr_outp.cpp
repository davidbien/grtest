...
__DGRAPH_BEGIN_NAMESPACE
  ...
  const _binary_rep_tokens< __false_type >::_TyToken  _binary_rep_tokens< __false_type >::ms_ucContextPop;
  const _binary_rep_tokens< __false_type >::_TyToken  _binary_rep_tokens< __false_type >::ms_ucNode;
  ...
  const _binary_rep_tokens< __false_type >::_TyToken  _binary_rep_tokens< __false_type >::ms_ucUnfinishedLinkFooter;
  const _binary_rep_tokens< __false_type >::_TyToken  _binary_rep_tokens< __false_type >::ms_ucGraphFooter;
