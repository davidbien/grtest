...
void
_destroy_children() _BIEN_NOTHROW
{
...
void
_destroy_parents() _BIEN_NOTHROW
{
...
void
_append_relations() _BIEN_NOTHROW
{
...
void
_append_children() _BIEN_NOTHROW
{
